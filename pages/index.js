import {Avatar, Flex, Grid, Heading, Stack, Text, useColorMode} from '@chakra-ui/react'
			...
			<Stack justifyContent="center" alignItems="flex-start" m="0 auto 4rem auto" px={2}>
				...
				<Flex flexDirection="column" justifyContent="flex-start" alignItems="center" gap={6}>
					...
					<Grid templateColumns='repeat(3, 1fr)' templateRows='repeat(3, 1fr)' gap={6}>
						...
						<IconInfo icon={<SiUnity size="4em"/>} color={InvColor[colorMode]}
					...
					<Grid templateColumns='repeat(3, 1fr)' templateRows='repeat(3, 1fr)' gap={6}>
						<IconInfo icon={<SiIntellijidea size="4em"/>} color={InvColor[colorMode]}
						...
						<IconInfo icon={<SiWebstorm size="4em"/>} color={InvColor[colorMode]}
								  title='Тут был написан весь сайт'
								  text="Лучшая IDE для того чтобы делать сайты."/>
						<IconInfo icon={<SiPycharm size="4em"/>} color={InvColor[colorMode]}
								  title='Первая IDE что я использовал'
								  text="дРаньше я использовал community а недавно приобрел premium."/>
						<IconInfo icon={<SiRider size="4em"/>} color={InvColor[colorMode]}
								  title='Visual studio за деньги'
								  text="IDE для всего что использует .NET"/>
						<IconInfo icon={<SiVisualstudio size="4em"/>} color='#5C2D91'
								  title='Лучшая .NET IDE за свои деньги'
								  text="IDE для всего что использует .NET"/>
						<IconInfo icon={<SiVisualstudiocode size="4em"/>} color='#007ACC'
